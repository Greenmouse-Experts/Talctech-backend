...
router.post("/add-criteria", AuthMiddleware.redirectLogin, CriteriaController.addCriteria);
router.post("/update-criteria", AuthMiddleware.redirectLogin, CriteriaController.updateUserCriteria);
...
router.get('/test/payment', testController.testPayment);
