                ...
                Property.findAll({
                    ...
                    .then(similarCriteria => {
                        similarCriteria.forEach(pairings => {
                            console.log(pairings.dataValues.id, pairings.id);
                            Pairing.create({
                                    tenant_id: req.session.userId,
                                    property_id: pairings.dataValues.id,
                                    landlord_id: pairings.user_id
                                })
                                .then(response => {
                        ...
                        .then(updatedCriteria => {
                            ...
                            Pairing.destroy({
                                ...
                                .then(deletedPairings => {
                                    console.log(req.body.property, req.body.offer, req.body.city);
                                    Property.findAll({
                                            where: {
                                                property_type: {
                                                    [Op.eq]: req.body.property
