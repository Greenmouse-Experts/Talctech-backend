...
exports.makePayment = async (req, res, next) => {
    ...
    if(req.session.userRole == 3) {
        fee = parameters.TENANT_FEE;
        plan = parameters.TENANT_PLAN_CODE;
    }

    // if(req.session.userRole == 4) {
    //     fee = parameters.RENTER_FEE;
    //     plan = parameters.RENTER_PLAN_CODE;
    // }

    if(req.session.userRole == 2) {
        fee = parameters.LANDLORD_FEE;
        plan = parameters.LANDLORD_PLAN_CODE;
    }
